...
public class BombSystem {
    ...
    private void activateBomb(float x, float y) {
        ...
        Particle wave = Particle.createBombWave(x, y, maxBombRadius, entityManager.getAssetManager());
        ...
        // Play bomb sound
        // entityManager.getAssetManager().get(AssetManager.BOMB_SOUND).play(0.8f);
    }
